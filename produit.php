...
</svg><a href="produit.php">Produits</a></li>
...
<?php if(isset($_GET['ajout']) && $_GET['ajout'] == "ok") {
    print '<div class="alert alert-success" width="30px">Produit ajouter avec succes</div>';
    
    }?>
    <div>
  <?php if(isset($_GET['delete']) && $_GET['delete'] == "ok") {
    print '<div class="alert alert-success" width="30px">Produit supprimer avec succes</div>';
    
    }?>
    <?php if(isset($_GET['erreur']) && $_GET['erreur'] == "duplicate") {
    print '<div class="alert alert-danger" width="30px">Ce nom de Produit déjà existe</div>';
    
    }?>
    <?php if(isset($_GET['modif']) && $_GET['modif'] == "ok") {
    print '<div class="alert alert-success" width="30px">Produit modifier avec succes</div>';
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nouvelle Produit</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="ajoutpd.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="forme-groupe">
            <input type="number" step="0.01" name="prix" required minlength="2" class="form-control" placeholder="prix de produit ...">
          </div>
         
          <div class="forme-groupe">
            <input type="file" name="image" required minlength="2" class="form-control" placeholder="nom de produit ...">
          </div>
...
<div class="modal fade" id="editModal<?php echo $categorie['id'] ;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="modifierpd.php" method="POST">
  <input type="hidden" value="<?php echo $categorie['id']; ?>" name="idc">
  <div class="forme-groupe">
    <input type="text" name="nom" value="<?php echo $categorie['nom']; ?>" class="form-control" placeholder="nom de produit ...">
  </div>

  <div class="forme-groupe">
    <textarea type="text" name="description" class="form-control" placeholder="description de produit ..."><?php echo $categorie['description']; ?></textarea>
  </div>
