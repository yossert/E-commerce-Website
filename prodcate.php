...
if(isset($_GET['id'])){
    $prodcat=getProdcatById($_GET['id']);
}
        ...
        <div class="main-section">
            <div class="card-container">
                <div class="card mb-3" style="max-width: 700px; max-height: 600px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="cat1/<?php echo $prodcat['images']; ?>" class="img-fluid rounded-start" alt="image">
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-container2">
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $prodcat['nom'] ?></h5>
                        <p class="card-text"><?php echo $prodcat['description'] ?></p>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><?php echo $prodcat['prix'] ?> DT</li>
                        </ul>
                        <div class="stars">
